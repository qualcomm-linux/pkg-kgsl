...
#ifndef __ADRENO_GEN8_1_0_SNAPSHOT_H
#define __ADRENO_GEN8_1_0_SNAPSHOT_H

#include "adreno_gen8_snapshot.h"

/*
 * gen8_1_0 specific GBIF debugbus blocks.
 * The data file puts DEBUGBUS_GBIF_GX_GC_US_I_0 in the main debugbus_blocks list,
 * so we use an empty list here and include it in gen8_1_0_debugbus_blocks instead.
 * CX blocks (GBIF_CX, GMU_CX, CX) are handled by gen8_cx_debugbus_blocks.
 */
static const u32 gen8_1_0_gbif_debugbus_blocks[] = {
	/* Empty - GBIF_GX is included in gen8_1_0_debugbus_blocks per data file */
};

static const u32 gen8_1_0_debugbus_blocks[] = {
	/* GBIF_GX block - included here per android_DXX_gen8_1_0_data.h */
	DEBUGBUS_GBIF_GX_GC_US_I_0,
	/* Note: CX blocks (GBIF_CX, GMU_CX, CX) are handled by gen8_cx_debugbus_blocks */
	...
	/* Slice 3 - gen8_1_0 has 4 slices */
	DEBUGBUS_CP_GC_S_3_I_0,
	DEBUGBUS_PC_BR_S_3_I_0,
	DEBUGBUS_PC_BV_S_3_I_0,
	DEBUGBUS_TESS_GC_S_3_I_0,
	DEBUGBUS_TSEFE_GC_S_3_I_0,
	DEBUGBUS_TSEBE_GC_S_3_I_0,
	DEBUGBUS_RAS_GC_S_3_I_0,
	DEBUGBUS_LRZ_BR_S_3_I_0,
	DEBUGBUS_LRZ_BV_S_3_I_0,
	DEBUGBUS_VFDP_GC_S_3_I_0,
	DEBUGBUS_GPC_BR_S_3_I_0,
	DEBUGBUS_GPC_BV_S_3_I_0,
	DEBUGBUS_VPCFE_BR_S_3_I_0,
	DEBUGBUS_VPCFE_BV_S_3_I_0,
	DEBUGBUS_VPCBE_BR_S_3_I_0,
	DEBUGBUS_VPCBE_BV_S_3_I_0,
	DEBUGBUS_CCHE_GC_S_3_I_0,
	DEBUGBUS_DBGC_GC_S_3_I_0,
	DEBUGBUS_LARC_GC_S_3_I_0,
	DEBUGBUS_RBBM_GC_S_3_I_0,
	DEBUGBUS_CCRE_GC_S_3_I_0,
	DEBUGBUS_CGC_GC_S_3_I_0,
	DEBUGBUS_GMU_GC_S_3_I_0,
	DEBUGBUS_SLICE_GC_S_3_I_0,
	DEBUGBUS_HLSQ_SPTP_STAR_GC_S_3_I_0,
	DEBUGBUS_USP_GC_S_3_I_0,
	DEBUGBUS_USP_GC_S_3_I_1,
	DEBUGBUS_USPTP_GC_S_3_I_0,
	DEBUGBUS_USPTP_GC_S_3_I_1,
	DEBUGBUS_USPTP_GC_S_3_I_2,
	DEBUGBUS_USPTP_GC_S_3_I_3,
	DEBUGBUS_TP_GC_S_3_I_0,
	DEBUGBUS_TP_GC_S_3_I_1,
	DEBUGBUS_TP_GC_S_3_I_2,
	DEBUGBUS_TP_GC_S_3_I_3,
	DEBUGBUS_RB_GC_S_3_I_0,
	DEBUGBUS_RB_GC_S_3_I_1,
	DEBUGBUS_CCU_GC_S_3_I_0,
	DEBUGBUS_CCU_GC_S_3_I_1,
	DEBUGBUS_HLSQ_GC_S_3_I_0,
	DEBUGBUS_HLSQ_GC_S_3_I_1,
	DEBUGBUS_VFD_GC_S_3_I_0,
	DEBUGBUS_VFD_GC_S_3_I_1,
};

/*
 * Shader blocks for gen8_1_0.
 *
 * Converted from android_DXX_gen8_1_0_data.h format to kernel format:
 * - Data file uses num_usptps (count) as 4th field
 * - Kernel uses usptp_id (specific ID) as 4th field
 * Expansion rules:
 *   USPTP location, num_usptps=2 -> 2 entries: uSPTP0 (0), uSPTP1 (1)
 *   SP_TOP location, num_usptps=2 -> 1 entry: SPTOP (15)
 *   HLSQ_STATE location, num_usptps=1 -> 1 entry: uSPTP0 (0)
 */
static struct gen8_shader_block gen8_1_0_shader_blocks[] = {
 ...
 * pairs   : 10 (Regs:62)
 */
static const u32 gen8_1_0_gbif_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gbif_registers), 8));
 ...
 * pairs   : 118 (Regs:1160)
 */
static const u32 gen8_1_0_gpu_registers[] = {
	0x00008, 0x0000d, 0x00010, 0x00013, 0x00015, 0x00016, 0x00018, 0x00018,
	...
	0x00071, 0x00072, 0x00074, 0x00074, 0x00076, 0x0007c, 0x0007f, 0x0009a,
	0x0009d, 0x000af, 0x000b2, 0x000d4, 0x000d7, 0x000e2, 0x000e5, 0x000e6,
	0x000e9, 0x000f1, 0x000f4, 0x000f6, 0x000f9, 0x00108, 0x0010b, 0x0010e,
	0x00111, 0x00111, 0x00114, 0x0011c, 0x0011f, 0x00121, 0x00125, 0x00125,
	0x00127, 0x00127, 0x00129, 0x00129, 0x0012b, 0x00131, 0x00134, 0x00138,
	0x0013a, 0x0013a, 0x0013c, 0x0013f, 0x00142, 0x00150, 0x00153, 0x00155,
	0x00158, 0x00159, 0x0015c, 0x0015c, 0x00166, 0x00179, 0x0019e, 0x001a3,
	0x001b0, 0x002c9, 0x002e2, 0x0036b, 0x00380, 0x0039b, 0x003a4, 0x003ab,
	0x003b4, 0x003c5, 0x003ce, 0x003cf, 0x003e0, 0x003e0, 0x003f0, 0x003f0,
	0x00440, 0x00444, 0x0044d, 0x0044f, 0x00460, 0x00460, 0x00c02, 0x00c04,
	0x00c06, 0x00c06, 0x00c10, 0x00cd9, 0x00ce0, 0x00d0c, 0x00df0, 0x00df4,
	0x00e01, 0x00e04, 0x00e06, 0x00e09, 0x00e0e, 0x00e13, 0x00e15, 0x00e18,
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gpu_registers), 8));
 ...
 * pairs   : 12 (Regs:89)
 */
static const u32 gen8_1_0_gpu_slice_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gpu_slice_registers), 8));
 ...
 * pairs   : 15 (Regs:174)
 */
static const u32 gen8_1_0_gmugx_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gmugx_registers), 8));
 ...
 * pairs   : 23 (Regs:314)
 */
static const u32 gen8_1_0_gmugx_slice_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gmugx_slice_registers), 8));
 ...
 * pairs   : 63 (Regs:290)
 */
static const u32 gen8_1_0_gmuao_registers[] = {
	...
	0x1b000, 0x1b063, 0x1b0ff, 0x1b163, 0x1b1ff, 0x1b200, 0x22400, 0x22401,
	0x22408, 0x22409, 0x22410, 0x22411, 0x22418, 0x22419, 0x22420, 0x22421,
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gmuao_registers), 8));
 ...
 * pairs   : 154 (Regs:819)
 */
static const u32 gen8_1_0_gmucx_registers[] = {
	...
	0x1f7a0, 0x1f7a7, 0x1f7b0, 0x1f7bd, 0x1f7e0, 0x1f7e1, 0x1f7e4, 0x1f7e5,
	...
	0x1fe74, 0x1fe78, 0x1fe88, 0x1fe8c, 0x1fe9c, 0x1fe9c, 0x1fec0, 0x1fec4,
	0x1fef0, 0x1fef1, 0x1fef4, 0x1fef8, 0x1ff08, 0x1ff0c, 0x1ff1c, 0x1ff1c,
	...
	0x20034, 0x20036, 0x20080, 0x2008d, 0x20120, 0x20120, 0x20128, 0x20128,
	...
	0x20410, 0x20414, 0x20420, 0x20422, 0x20480, 0x2048d, 0x20800, 0x20806,
	0x20810, 0x20811, 0x20814, 0x20815, 0x20820, 0x20838, 0x20840, 0x20841,
	0x20844, 0x20845, 0x20850, 0x20868,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gmucx_registers), 8));
 ...
 * pairs   : 7 (Regs:71)
 */
static const u32 gen8_1_0_cx_misc_registers[] = {
	0x27800, 0x27800, 0x27810, 0x27814, 0x27820, 0x27824, 0x27828, 0x2782a,
	0x27832, 0x27857, 0x27880, 0x2788c, 0x27c00, 0x27c05,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cx_misc_registers), 8));
 ...
 * pairs   : 21 (Regs:152)
 */
static const u32 gen8_1_0_dbgc_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_dbgc_registers), 8));
 ...
 * pairs   : 2 (Regs:61)
 */
static const u32 gen8_1_0_dbgc_slice_registers[] = {
	0x007a0, 0x007d5, 0x007e0, 0x007e6,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_dbgc_slice_registers), 8));
 ...
 * pairs   : 6 (Regs:75)
 */
static const u32 gen8_1_0_cx_dbgc_registers[] = {
	0x18400, 0x1841c, 0x1841e, 0x1843d, 0x18440, 0x18444, 0x18450, 0x18455,
	0x1846a, 0x1846a, 0x18580, 0x18581,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cx_dbgc_registers), 8));
 ...
 * pairs   : 15 (Regs:310)
 */
static const u32 gen8_1_0_cp_cp_pipe_none_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cp_cp_pipe_none_registers), 8));
 ...
 * pairs   : 8 (Regs:96)
 */
static const u32 gen8_1_0_cp_cp_pipe_br_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cp_cp_pipe_br_registers), 8));
 ...
 * pairs   : 4 (Regs:23)
 */
static const u32 gen8_1_0_cp_slice_cp_pipe_br_registers[] = {
	0x00b00, 0x00b0c, 0x00b10, 0x00b10, 0x00b80, 0x00b84, 0x00b90, 0x00b93,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cp_slice_cp_pipe_br_registers), 8));
 ...
 * pairs   : 9 (Regs:72)
 */
static const u32 gen8_1_0_cp_cp_pipe_bv_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cp_cp_pipe_bv_registers), 8));
 ...
 * pairs   : 4 (Regs:23)
 */
static const u32 gen8_1_0_cp_slice_cp_pipe_bv_registers[] = {
	0x00b00, 0x00b0c, 0x00b10, 0x00b10, 0x00b80, 0x00b84, 0x00b90, 0x00b93,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cp_slice_cp_pipe_bv_registers), 8));
 ...
 * pairs   : 9 (Regs:77)
 */
static const u32 gen8_1_0_cp_cp_pipe_lpac_registers[] = {
	0x00830, 0x00837, 0x0084d, 0x0084f, 0x008a0, 0x008b4, 0x008b7, 0x008bb,
	0x008f0, 0x008f5, 0x008f8, 0x008f9, 0x00900, 0x00913, 0x00918, 0x0091d,
	0x00920, 0x00925,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cp_cp_pipe_lpac_registers), 8));
 ...
 * pairs   : 10 (Regs:22)
 */
static const u32 gen8_1_0_cp_cp_pipe_aqe0_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cp_cp_pipe_aqe0_registers), 8));
 ...
 * pairs   : 10 (Regs:22)
 */
static const u32 gen8_1_0_cp_cp_pipe_aqe1_registers[] = {
	0x0084d, 0x0084d, 0x008b0, 0x008b4, 0x008b7, 0x008b9, 0x008bb, 0x008bb,
	0x008f0, 0x008f1, 0x008f4, 0x008f5, 0x008f8, 0x008f9, 0x00910, 0x00913,
	0x0091d, 0x0091d, 0x00925, 0x00925,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cp_cp_pipe_aqe1_registers), 8));
 ...
 * pairs   : 11 (Regs:36)
 */
static const u32 gen8_1_0_cp_cp_pipe_dde_br_registers[] = {
	0x0084d, 0x0084d, 0x008b0, 0x008b4, 0x008b7, 0x008b9, 0x008bb, 0x008bb,
	0x008f0, 0x008f1, 0x008f4, 0x008f5, 0x008f8, 0x008f9, 0x008fe, 0x008ff,
	0x0090c, 0x00917, 0x0091c, 0x0091e, 0x00924, 0x00926,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cp_cp_pipe_dde_br_registers), 8));
 ...
 * pairs   : 11 (Regs:36)
 */
static const u32 gen8_1_0_cp_cp_pipe_dde_bv_registers[] = {
	0x0084d, 0x0084d, 0x008b0, 0x008b4, 0x008b7, 0x008b9, 0x008bb, 0x008bb,
	0x008f0, 0x008f1, 0x008f4, 0x008f5, 0x008f8, 0x008f9, 0x008fe, 0x008ff,
	0x0090c, 0x00917, 0x0091c, 0x0091e, 0x00924, 0x00926,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cp_cp_pipe_dde_bv_registers), 8));

/*
 * Non-context PIPE_BR unsliced registers
 * pairs   : 10 (Regs:1125)
 */
static const u32 gen8_1_0_non_context_pipe_br_registers[] = {
	0x09600, 0x09605, 0x09610, 0x09617, 0x09620, 0x09627, 0x09670, 0x0967b,
	0x09e00, 0x09e15, 0x09e17, 0x09e23, 0x09e30, 0x09e3f, 0x09e50, 0x09e59,
	0x09e60, 0x09e65, 0x0d200, 0x0d5ff,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_non_context_pipe_br_registers), 8));

/*
 * Non-context PIPE_BR sliced registers
 * pairs   : 21 (Regs:301)
 */
static const u32 gen8_1_0_non_context_slice_pipe_br_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_non_context_slice_pipe_br_registers), 8));

/*
 * Non-context PIPE_BV unsliced registers
 * pairs   : 11 (Regs:1124)
 */
static const u32 gen8_1_0_non_context_pipe_bv_registers[] = {
	0x09600, 0x09605, 0x09610, 0x09617, 0x09620, 0x09627, 0x09670, 0x0967b,
	0x09e00, 0x09e04, 0x09e06, 0x09e15, 0x09e17, 0x09e23, 0x09e30, 0x09e3f,
	0x09e50, 0x09e59, 0x09e60, 0x09e65, 0x0d200, 0x0d5ff,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_non_context_pipe_bv_registers), 8));

/*
 * Non-context PIPE_BV sliced registers
 * pairs   : 21 (Regs:301)
 */
static const u32 gen8_1_0_non_context_slice_pipe_bv_registers[] = {
	0x08600, 0x08602, 0x08610, 0x08613, 0x08700, 0x08704, 0x08710, 0x08713,
	0x08720, 0x08723, 0x08730, 0x08733, 0x08740, 0x08744, 0x09680, 0x09681,
	0x09690, 0x0969b, 0x09740, 0x09745, 0x09750, 0x0975b, 0x09770, 0x097ef,
	0x09f00, 0x09f0f, 0x09f20, 0x09f23, 0x09f30, 0x09f31, 0x0a600, 0x0a600,
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_non_context_slice_pipe_bv_registers), 8));

/*
 * Non-context PIPE_LPAC unsliced registers
 * pairs   : 1 (Regs:1)
 */
static const u32 gen8_1_0_non_context_pipe_lpac_registers[] = {
	0x00e14, 0x00e14,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_non_context_pipe_lpac_registers), 8));
 ...
 * pairs   : 4 (Regs:26)
 */
static const u32 gen8_1_0_non_context_rb_pipe_br_rbp_registers[] = {
	0x08f00, 0x08f07, 0x08f10, 0x08f15, 0x08f20, 0x08f29, 0x08f30, 0x08f31,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_non_context_rb_pipe_br_rbp_registers), 8));

/*
 * Block   : ['RB']
 * REGION  : SLICE
 * Pipeline: PIPE_BR
 * Cluster : CLUSTER_NONE (RAC)
 * pairs   : 5 (Regs:46)
 */
static const u32 gen8_1_0_non_context_rb_slice_pipe_br_rac_registers[] = {
	0x08e09, 0x08e0b, 0x08e10, 0x08e17, 0x08e51, 0x08e5a, 0x08e69, 0x08e71,
	0x08ea0, 0x08eaf,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_non_context_rb_slice_pipe_br_rac_registers), 8));

/*
 * Block   : ['RB']
 * REGION  : SLICE
 * Pipeline: PIPE_BR
 * Cluster : CLUSTER_NONE (RBP)
 * pairs   : 9 (Regs:31)
 */
static const u32 gen8_1_0_non_context_rb_slice_pipe_br_rbp_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_non_context_rb_slice_pipe_br_rbp_registers), 8));
 ...
 * pairs   : 10 (Regs:99)
 */
static const u32 gen8_1_0_non_context_sp_pipe_none_hlsq_state_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_non_context_sp_pipe_none_hlsq_state_registers), 8));
 ...
 * pairs   : 6 (Regs:60)
 */
static const u32 gen8_1_0_non_context_sp_pipe_none_sp_top_registers[] = {
	0x0ae00, 0x0ae0c, 0x0ae0f, 0x0ae0f, 0x0ae35, 0x0ae35, 0x0ae3a, 0x0ae3f,
	0x0ae50, 0x0ae52, 0x0ae80, 0x0aea3,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_non_context_sp_pipe_none_sp_top_registers), 8));
 ...
 * pairs   : 9 (Regs:64)
 */
static const u32 gen8_1_0_non_context_sp_pipe_none_usptp_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_non_context_sp_pipe_none_usptp_registers), 8));
 ...
 * pairs   : 5 (Regs:48)
 */
static const u32 gen8_1_0_non_context_tpl1_pipe_none_usptp_registers[] = {
	0x0b600, 0x0b600, 0x0b602, 0x0b602, 0x0b604, 0x0b604, 0x0b606, 0x0b61e,
	0x0b620, 0x0b633,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_non_context_tpl1_pipe_none_usptp_registers), 8));
 ...
 * pairs   : 8 (Regs:232)
 */
static const u32 gen8_1_0_gras_slice_pipe_br_cluster_vpc_vs_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gras_slice_pipe_br_cluster_vpc_vs_registers), 8));
 ...
 * pairs   : 13 (Regs:326)
 */
static const u32 gen8_1_0_gras_slice_pipe_br_cluster_gras_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gras_slice_pipe_br_cluster_gras_registers), 8));
 ...
 * pairs   : 8 (Regs:232)
 */
static const u32 gen8_1_0_gras_slice_pipe_bv_cluster_vpc_vs_registers[] = {
	0x08200, 0x08213, 0x08220, 0x08225, 0x08230, 0x0823b, 0x08240, 0x0825f,
	0x08270, 0x0828f, 0x0829f, 0x082b7, 0x082d0, 0x0832f, 0x08500, 0x08508,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gras_slice_pipe_bv_cluster_vpc_vs_registers), 8));
 ...
 * pairs   : 13 (Regs:326)
 */
static const u32 gen8_1_0_gras_slice_pipe_bv_cluster_gras_registers[] = {
	0x08080, 0x08080, 0x08086, 0x08092, 0x080c0, 0x080df, 0x08101, 0x08110,
	0x08130, 0x0814f, 0x08200, 0x08213, 0x08220, 0x08225, 0x08230, 0x0823b,
	0x08240, 0x0825f, 0x08270, 0x0828f, 0x0829f, 0x082b7, 0x082d0, 0x0832f,
	0x08500, 0x08508,
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gras_slice_pipe_bv_cluster_gras_registers), 8));
 ...
 * pairs   : 6 (Regs:35)
 */
static const u32 gen8_1_0_pc_pipe_br_cluster_fe_us_registers[] = {
	0x09805, 0x09807, 0x0980b, 0x0980b, 0x09812, 0x09817, 0x0981a, 0x0981b,
	0x09b00, 0x09b0d, 0x09b10, 0x09b18,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_pc_pipe_br_cluster_fe_us_registers), 8));
 ...
 * pairs   : 2 (Regs:23)
 */
static const u32 gen8_1_0_pc_slice_pipe_br_cluster_fe_s_registers[] = {
	0x09b00, 0x09b0d, 0x09b10, 0x09b18,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_pc_slice_pipe_br_cluster_fe_s_registers), 8));
 ...
 * pairs   : 6 (Regs:35)
 */
static const u32 gen8_1_0_pc_pipe_bv_cluster_fe_us_registers[] = {
	0x09805, 0x09807, 0x0980b, 0x0980b, 0x09812, 0x09817, 0x0981a, 0x0981b,
	0x09b00, 0x09b0d, 0x09b10, 0x09b18,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_pc_pipe_bv_cluster_fe_us_registers), 8));
 ...
 * pairs   : 2 (Regs:23)
 */
static const u32 gen8_1_0_pc_slice_pipe_bv_cluster_fe_s_registers[] = {
	0x09b00, 0x09b0d, 0x09b10, 0x09b18,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_pc_slice_pipe_bv_cluster_fe_s_registers), 8));
 ...
 * pairs   : 2 (Regs:236)
 */
static const u32 gen8_1_0_vfd_slice_pipe_br_cluster_fe_s_registers[] = {
	0x0a000, 0x0a009, 0x0a00e, 0x0a0ef,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_vfd_slice_pipe_br_cluster_fe_s_registers), 8));
 ...
 * pairs   : 2 (Regs:236)
 */
static const u32 gen8_1_0_vfd_slice_pipe_bv_cluster_fe_s_registers[] = {
	0x0a000, 0x0a009, 0x0a00e, 0x0a0ef,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_vfd_slice_pipe_bv_cluster_fe_s_registers), 8));
 ...
 * pairs   : 1 (Regs:27)
 */
static const u32 gen8_1_0_vpc_slice_pipe_br_cluster_fe_s_registers[] = {
	0x09300, 0x0931a,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_vpc_slice_pipe_br_cluster_fe_s_registers), 8));
 ...
 * pairs   : 2 (Regs:29)
 */
static const u32 gen8_1_0_vpc_slice_pipe_br_cluster_vpc_vs_registers[] = {
	0x090c0, 0x090c1, 0x09300, 0x0931a,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_vpc_slice_pipe_br_cluster_vpc_vs_registers), 8));
 ...
 * pairs   : 3 (Regs:58)
 */
static const u32 gen8_1_0_vpc_pipe_br_cluster_vpc_us_registers[] = {
	0x09180, 0x09180, 0x09182, 0x0919f, 0x09300, 0x0931a,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_vpc_pipe_br_cluster_vpc_us_registers), 8));
 ...
 * pairs   : 4 (Regs:52)
 */
static const u32 gen8_1_0_vpc_slice_pipe_br_cluster_vpc_ps_registers[] = {
	0x09240, 0x0924f, 0x09252, 0x09255, 0x09278, 0x0927c, 0x09300, 0x0931a,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_vpc_slice_pipe_br_cluster_vpc_ps_registers), 8));
 ...
 * pairs   : 1 (Regs:27)
 */
static const u32 gen8_1_0_vpc_slice_pipe_bv_cluster_fe_s_registers[] = {
	0x09300, 0x0931a,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_vpc_slice_pipe_bv_cluster_fe_s_registers), 8));
 ...
 * pairs   : 2 (Regs:29)
 */
static const u32 gen8_1_0_vpc_slice_pipe_bv_cluster_vpc_vs_registers[] = {
	0x090c0, 0x090c1, 0x09300, 0x0931a,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_vpc_slice_pipe_bv_cluster_vpc_vs_registers), 8));
 ...
 * pairs   : 3 (Regs:58)
 */
static const u32 gen8_1_0_vpc_pipe_bv_cluster_vpc_us_registers[] = {
	0x09180, 0x09180, 0x09182, 0x0919f, 0x09300, 0x0931a,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_vpc_pipe_bv_cluster_vpc_us_registers), 8));
 ...
 * pairs   : 4 (Regs:52)
 */
static const u32 gen8_1_0_vpc_slice_pipe_bv_cluster_vpc_ps_registers[] = {
	0x09240, 0x0924f, 0x09252, 0x09255, 0x09278, 0x0927c, 0x09300, 0x0931a,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_vpc_slice_pipe_bv_cluster_vpc_ps_registers), 8));

/*
 * Block   : ['RB']
 * REGION  : SLICE
 * Pipeline: PIPE_BR
 * Cluster : CLUSTER_PS (RAC)
 * pairs   : 36 (Regs:151)
 */
static const u32 gen8_1_0_rb_slice_pipe_br_cluster_ps_rac_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_rb_slice_pipe_br_cluster_ps_rac_registers), 8));

/*
 * Block   : ['RB']
 * REGION  : SLICE
 * Pipeline: PIPE_BR
 * Cluster : CLUSTER_PS (RBP)
 * pairs   : 36 (Regs:104)
 */
static const u32 gen8_1_0_rb_slice_pipe_br_cluster_ps_rbp_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_rb_slice_pipe_br_cluster_ps_rbp_registers), 8));

/* SP cluster registers - PIPE_BR, CLUSTER_SP_VS */
static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_cctx_registers[] = {
	0x0a8a0, 0x0a8af, 0x0ab0a, 0x0ab1b,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_cctx_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_shared_const_registers[] = {
	0x0ab30, 0x0abcf,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_shared_const_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_sp_top_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_sp_top_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_sp_top_cctx_registers[] = {
	0x0a8a0, 0x0a8af, 0x0ab0a, 0x0ab1b,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_sp_top_cctx_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_usptp_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_usptp_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_usptp_shared_const_registers[] = {
	0x0ab30, 0x0abcf,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_usptp_shared_const_registers), 8));

/* SP cluster registers - PIPE_BR, CLUSTER_SP_PS */
static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_cctx_registers[] = {
	0x0a9e0, 0x0a9f9, 0x0ab0a, 0x0ab1b,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_cctx_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_shared_const_registers[] = {
	0x0aa40, 0x0aadf, 0x0ab30, 0x0abcf,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_shared_const_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_dp_registers[] = {
	0x0a9b0, 0x0a9b1, 0x0a9d4, 0x0a9df,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_dp_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_sp_top_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_sp_top_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_sp_top_cctx_registers[] = {
	0x0a9e0, 0x0a9f9, 0x0ab0a, 0x0ab1b,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_sp_top_cctx_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_usptp_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_usptp_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_usptp_shared_const_registers[] = {
	0x0aa40, 0x0aadf, 0x0ab30, 0x0abcf,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_usptp_shared_const_registers), 8));

/* SP cluster registers - PIPE_BV, CLUSTER_SP_VS */
static const u32 gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_registers[] = {
	0x0a800, 0x0a801, 0x0a81b, 0x0a81d, 0x0a822, 0x0a822, 0x0a824, 0x0a824,
	0x0a827, 0x0a82a, 0x0a82e, 0x0a82e, 0x0a830, 0x0a830, 0x0a832, 0x0a835,
	0x0a83a, 0x0a83a, 0x0a83c, 0x0a83c, 0x0a83f, 0x0a841, 0x0a85b, 0x0a85d,
	0x0a862, 0x0a862, 0x0a864, 0x0a864, 0x0a867, 0x0a867, 0x0a870, 0x0a870,
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_cctx_registers[] = {
	0x0a8a0, 0x0a8af, 0x0ab0a, 0x0ab1b,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_cctx_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_shared_const_registers[] = {
	0x0ab30, 0x0abcf,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_shared_const_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_sp_top_registers[] = {
	0x0a800, 0x0a800, 0x0a81c, 0x0a81d, 0x0a822, 0x0a824, 0x0a826, 0x0a827,
	0x0a82d, 0x0a82d, 0x0a82f, 0x0a831, 0x0a834, 0x0a835, 0x0a83a, 0x0a83c,
	0x0a83e, 0x0a840, 0x0a85c, 0x0a85d, 0x0a862, 0x0a864, 0x0a866, 0x0a868,
	0x0a870, 0x0a871, 0x0a88d, 0x0a88e, 0x0a893, 0x0a895, 0x0a897, 0x0a899,
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_sp_top_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_sp_top_cctx_registers[] = {
	0x0a8a0, 0x0a8af, 0x0ab0a, 0x0ab1b,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_sp_top_cctx_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_usptp_registers[] = {
	0x0a800, 0x0a81b, 0x0a81e, 0x0a821, 0x0a823, 0x0a827, 0x0a82d, 0x0a82d,
	0x0a82f, 0x0a833, 0x0a836, 0x0a839, 0x0a83b, 0x0a85b, 0x0a85e, 0x0a861,
	0x0a863, 0x0a868, 0x0a870, 0x0a88c, 0x0a88f, 0x0a892, 0x0a894, 0x0a899,
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_usptp_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_usptp_shared_const_registers[] = {
	0x0ab30, 0x0abcf,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_usptp_shared_const_registers), 8));

/* SP cluster registers - PIPE_LPAC, CLUSTER_SP_PS */
static const u32 gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_hlsq_state_registers[] = {
...
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_hlsq_state_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_hlsq_state_cctx_registers[] = {
	0x0a9e2, 0x0a9e3, 0x0a9e6, 0x0a9f9,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_hlsq_state_cctx_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_hlsq_state_shared_const_registers[] = {
	0x0aa40, 0x0aadf, 0x0ab30, 0x0abcf,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_hlsq_state_shared_const_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_hlsq_dp_registers[] = {
	0x0a9b0, 0x0a9b1, 0x0a9d4, 0x0a9df,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_hlsq_dp_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_sp_top_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_sp_top_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_sp_top_cctx_registers[] = {
	0x0a9e2, 0x0a9e3, 0x0a9e6, 0x0a9f9,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_sp_top_cctx_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_usptp_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_usptp_registers), 8));

static const u32 gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_usptp_shared_const_registers[] = {
	0x0aa40, 0x0aadf, 0x0ab30, 0x0abcf,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(
	sizeof(gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_usptp_shared_const_registers), 8));

/* TPL1 cluster registers */
static const u32 gen8_1_0_tpl1_slice_pipe_br_cluster_sp_vs_usptp_registers[] = {
	0x0b300, 0x0b304, 0x0b307, 0x0b307, 0x0b309, 0x0b309,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_tpl1_slice_pipe_br_cluster_sp_vs_usptp_registers), 8));

static const u32 gen8_1_0_tpl1_slice_pipe_br_cluster_sp_ps_usptp_registers[] = {
	0x0b180, 0x0b182, 0x0b2c0, 0x0b2d7, 0x0b300, 0x0b304, 0x0b307, 0x0b307,
	0x0b309, 0x0b309,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_tpl1_slice_pipe_br_cluster_sp_ps_usptp_registers), 8));

static const u32 gen8_1_0_tpl1_slice_pipe_bv_cluster_sp_vs_usptp_registers[] = {
	0x0b300, 0x0b304, 0x0b307, 0x0b307, 0x0b309, 0x0b309,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_tpl1_slice_pipe_bv_cluster_sp_vs_usptp_registers), 8));

static const u32 gen8_1_0_tpl1_slice_pipe_lpac_cluster_sp_ps_usptp_registers[] = {
	0x0b180, 0x0b181, 0x0b300, 0x0b301, 0x0b304, 0x0b304, 0x0b307, 0x0b307,
	0x0b309, 0x0b309,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_tpl1_slice_pipe_lpac_cluster_sp_ps_usptp_registers), 8));

/* RB sub-block selector registers */
static const struct sel_reg gen8_1_0_rb_rac_sel = {
	.host_reg = GEN8_RB_SUB_BLOCK_SEL_CNTL_HOST,
	.cd_reg = GEN8_RB_SUB_BLOCK_SEL_CNTL_CD,
	.val = 0,
};

static const struct sel_reg gen8_1_0_rb_rbp_sel = {
	.host_reg = GEN8_RB_SUB_BLOCK_SEL_CNTL_HOST,
	.cd_reg = GEN8_RB_SUB_BLOCK_SEL_CNTL_CD,
	.val = 0x9,
};
...
/*
 * CP cluster registers.
 * Note: Uses PIPE_* constants (same values as CP_PIPE_* in data file).
 */
static struct gen8_cluster_registers gen8_1_0_cp_clusters[] = {
	{ CLUSTER_NONE, UNSLICE, PIPE_NONE, STATE_NON_CONTEXT,
		gen8_1_0_cp_cp_pipe_none_registers, },
	{ CLUSTER_NONE, UNSLICE, PIPE_BR, STATE_NON_CONTEXT,
		gen8_1_0_cp_cp_pipe_br_registers, },
	{ CLUSTER_NONE, SLICE, PIPE_BR, STATE_NON_CONTEXT,
		gen8_1_0_cp_slice_cp_pipe_br_registers, },
	{ CLUSTER_NONE, UNSLICE, PIPE_BV, STATE_NON_CONTEXT,
		gen8_1_0_cp_cp_pipe_bv_registers, },
	{ CLUSTER_NONE, SLICE, PIPE_BV, STATE_NON_CONTEXT,
		gen8_1_0_cp_slice_cp_pipe_bv_registers, },
	{ CLUSTER_NONE, UNSLICE, PIPE_LPAC, STATE_NON_CONTEXT,
		gen8_1_0_cp_cp_pipe_lpac_registers, },
	{ CLUSTER_NONE, UNSLICE, PIPE_AQE0, STATE_NON_CONTEXT,
		gen8_1_0_cp_cp_pipe_aqe0_registers, },
	{ CLUSTER_NONE, UNSLICE, PIPE_AQE1, STATE_NON_CONTEXT,
		gen8_1_0_cp_cp_pipe_aqe1_registers, },
	{ CLUSTER_NONE, UNSLICE, PIPE_DDE_BR, STATE_NON_CONTEXT,
		gen8_1_0_cp_cp_pipe_dde_br_registers, },
	{ CLUSTER_NONE, UNSLICE, PIPE_DDE_BV, STATE_NON_CONTEXT,
		gen8_1_0_cp_cp_pipe_dde_bv_registers, },
};

/* MVC (multi-view context) cluster registers */
static struct gen8_cluster_registers gen8_1_0_mvc_clusters[] = {
	{ CLUSTER_NONE, UNSLICE, PIPE_BR, STATE_NON_CONTEXT,
		gen8_1_0_non_context_pipe_br_registers, },
	{ CLUSTER_NONE, SLICE, PIPE_BR, STATE_NON_CONTEXT,
		gen8_1_0_non_context_slice_pipe_br_registers, },
	{ CLUSTER_NONE, UNSLICE, PIPE_BV, STATE_NON_CONTEXT,
		gen8_1_0_non_context_pipe_bv_registers, },
	{ CLUSTER_NONE, SLICE, PIPE_BV, STATE_NON_CONTEXT,
		gen8_1_0_non_context_slice_pipe_bv_registers, },
	{ CLUSTER_NONE, UNSLICE, PIPE_LPAC, STATE_NON_CONTEXT,
		gen8_1_0_non_context_pipe_lpac_registers, },
	{ CLUSTER_NONE, UNSLICE, PIPE_BR, STATE_NON_CONTEXT,
		gen8_1_0_non_context_rb_pipe_br_rbp_registers, &gen8_1_0_rb_rbp_sel, },
	{ CLUSTER_NONE, SLICE, PIPE_BR, STATE_NON_CONTEXT,
		gen8_1_0_non_context_rb_slice_pipe_br_rac_registers, &gen8_1_0_rb_rac_sel, },
	{ CLUSTER_NONE, SLICE, PIPE_BR, STATE_NON_CONTEXT,
		gen8_1_0_non_context_rb_slice_pipe_br_rbp_registers, &gen8_1_0_rb_rbp_sel, },
	{ CLUSTER_PS, SLICE, PIPE_BR, STATE_FORCE_CTXT_0,
		gen8_1_0_rb_slice_pipe_br_cluster_ps_rac_registers, &gen8_1_0_rb_rac_sel, },
	{ CLUSTER_PS, SLICE, PIPE_BR, STATE_FORCE_CTXT_1,
		gen8_1_0_rb_slice_pipe_br_cluster_ps_rac_registers, &gen8_1_0_rb_rac_sel, },
	{ CLUSTER_PS, SLICE, PIPE_BR, STATE_FORCE_CTXT_0,
		gen8_1_0_rb_slice_pipe_br_cluster_ps_rbp_registers, &gen8_1_0_rb_rbp_sel, },
	{ CLUSTER_PS, SLICE, PIPE_BR, STATE_FORCE_CTXT_1,
		gen8_1_0_rb_slice_pipe_br_cluster_ps_rbp_registers, &gen8_1_0_rb_rbp_sel, },
	{ CLUSTER_VPC_VS, SLICE, PIPE_BR, STATE_FORCE_CTXT_0,
		gen8_1_0_gras_slice_pipe_br_cluster_vpc_vs_registers, },
	{ CLUSTER_VPC_VS, SLICE, PIPE_BR, STATE_FORCE_CTXT_1,
		gen8_1_0_gras_slice_pipe_br_cluster_vpc_vs_registers, },
	{ CLUSTER_GRAS, SLICE, PIPE_BR, STATE_FORCE_CTXT_0,
		gen8_1_0_gras_slice_pipe_br_cluster_gras_registers, },
	{ CLUSTER_GRAS, SLICE, PIPE_BR, STATE_FORCE_CTXT_1,
		gen8_1_0_gras_slice_pipe_br_cluster_gras_registers, },
	{ CLUSTER_VPC_VS, SLICE, PIPE_BV, STATE_FORCE_CTXT_0,
		gen8_1_0_gras_slice_pipe_bv_cluster_vpc_vs_registers, },
	{ CLUSTER_VPC_VS, SLICE, PIPE_BV, STATE_FORCE_CTXT_1,
		gen8_1_0_gras_slice_pipe_bv_cluster_vpc_vs_registers, },
	{ CLUSTER_GRAS, SLICE, PIPE_BV, STATE_FORCE_CTXT_0,
		gen8_1_0_gras_slice_pipe_bv_cluster_gras_registers, },
	{ CLUSTER_GRAS, SLICE, PIPE_BV, STATE_FORCE_CTXT_1,
		gen8_1_0_gras_slice_pipe_bv_cluster_gras_registers, },
	{ CLUSTER_FE_US, UNSLICE, PIPE_BR, STATE_FORCE_CTXT_0,
		gen8_1_0_pc_pipe_br_cluster_fe_us_registers, },
	{ CLUSTER_FE_US, UNSLICE, PIPE_BR, STATE_FORCE_CTXT_1,
		gen8_1_0_pc_pipe_br_cluster_fe_us_registers, },
	{ CLUSTER_FE_S, SLICE, PIPE_BR, STATE_FORCE_CTXT_0,
		gen8_1_0_pc_slice_pipe_br_cluster_fe_s_registers, },
	{ CLUSTER_FE_S, SLICE, PIPE_BR, STATE_FORCE_CTXT_1,
		gen8_1_0_pc_slice_pipe_br_cluster_fe_s_registers, },
	{ CLUSTER_FE_US, UNSLICE, PIPE_BV, STATE_FORCE_CTXT_0,
		gen8_1_0_pc_pipe_bv_cluster_fe_us_registers, },
	{ CLUSTER_FE_US, UNSLICE, PIPE_BV, STATE_FORCE_CTXT_1,
		gen8_1_0_pc_pipe_bv_cluster_fe_us_registers, },
	{ CLUSTER_FE_S, SLICE, PIPE_BV, STATE_FORCE_CTXT_0,
		gen8_1_0_pc_slice_pipe_bv_cluster_fe_s_registers, },
	{ CLUSTER_FE_S, SLICE, PIPE_BV, STATE_FORCE_CTXT_1,
		gen8_1_0_pc_slice_pipe_bv_cluster_fe_s_registers, },
	{ CLUSTER_FE_S, SLICE, PIPE_BR, STATE_FORCE_CTXT_0,
		gen8_1_0_vfd_slice_pipe_br_cluster_fe_s_registers, },
	{ CLUSTER_FE_S, SLICE, PIPE_BR, STATE_FORCE_CTXT_1,
		gen8_1_0_vfd_slice_pipe_br_cluster_fe_s_registers, },
	{ CLUSTER_FE_S, SLICE, PIPE_BV, STATE_FORCE_CTXT_0,
		gen8_1_0_vfd_slice_pipe_bv_cluster_fe_s_registers, },
	{ CLUSTER_FE_S, SLICE, PIPE_BV, STATE_FORCE_CTXT_1,
		gen8_1_0_vfd_slice_pipe_bv_cluster_fe_s_registers, },
	{ CLUSTER_FE_S, SLICE, PIPE_BR, STATE_FORCE_CTXT_0,
		gen8_1_0_vpc_slice_pipe_br_cluster_fe_s_registers, },
	{ CLUSTER_FE_S, SLICE, PIPE_BR, STATE_FORCE_CTXT_1,
		gen8_1_0_vpc_slice_pipe_br_cluster_fe_s_registers, },
	{ CLUSTER_VPC_VS, SLICE, PIPE_BR, STATE_FORCE_CTXT_0,
		gen8_1_0_vpc_slice_pipe_br_cluster_vpc_vs_registers, },
	{ CLUSTER_VPC_VS, SLICE, PIPE_BR, STATE_FORCE_CTXT_1,
		gen8_1_0_vpc_slice_pipe_br_cluster_vpc_vs_registers, },
	{ CLUSTER_VPC_US, UNSLICE, PIPE_BR, STATE_FORCE_CTXT_0,
		gen8_1_0_vpc_pipe_br_cluster_vpc_us_registers, },
	{ CLUSTER_VPC_US, UNSLICE, PIPE_BR, STATE_FORCE_CTXT_1,
		gen8_1_0_vpc_pipe_br_cluster_vpc_us_registers, },
	{ CLUSTER_VPC_PS, SLICE, PIPE_BR, STATE_FORCE_CTXT_0,
		gen8_1_0_vpc_slice_pipe_br_cluster_vpc_ps_registers, },
	{ CLUSTER_VPC_PS, SLICE, PIPE_BR, STATE_FORCE_CTXT_1,
		gen8_1_0_vpc_slice_pipe_br_cluster_vpc_ps_registers, },
	{ CLUSTER_FE_S, SLICE, PIPE_BV, STATE_FORCE_CTXT_0,
		gen8_1_0_vpc_slice_pipe_bv_cluster_fe_s_registers, },
	{ CLUSTER_FE_S, SLICE, PIPE_BV, STATE_FORCE_CTXT_1,
		gen8_1_0_vpc_slice_pipe_bv_cluster_fe_s_registers, },
	{ CLUSTER_VPC_VS, SLICE, PIPE_BV, STATE_FORCE_CTXT_0,
		gen8_1_0_vpc_slice_pipe_bv_cluster_vpc_vs_registers, },
	{ CLUSTER_VPC_VS, SLICE, PIPE_BV, STATE_FORCE_CTXT_1,
		gen8_1_0_vpc_slice_pipe_bv_cluster_vpc_vs_registers, },
	{ CLUSTER_VPC_US, UNSLICE, PIPE_BV, STATE_FORCE_CTXT_0,
		gen8_1_0_vpc_pipe_bv_cluster_vpc_us_registers, },
	{ CLUSTER_VPC_US, UNSLICE, PIPE_BV, STATE_FORCE_CTXT_1,
		gen8_1_0_vpc_pipe_bv_cluster_vpc_us_registers, },
	{ CLUSTER_VPC_PS, SLICE, PIPE_BV, STATE_FORCE_CTXT_0,
		gen8_1_0_vpc_slice_pipe_bv_cluster_vpc_ps_registers, },
	{ CLUSTER_VPC_PS, SLICE, PIPE_BV, STATE_FORCE_CTXT_1,
		gen8_1_0_vpc_slice_pipe_bv_cluster_vpc_ps_registers, },
};

/* SPTP cluster registers */
static struct gen8_sptp_cluster_registers gen8_1_0_sptp_clusters[] = {
	{ CLUSTER_NONE, UNSLICE, 2, 1, SP_NCTX_REG, PIPE_NONE, 0, HLSQ_STATE,
		gen8_1_0_non_context_sp_pipe_none_hlsq_state_registers, 0xae00},
	{ CLUSTER_NONE, UNSLICE, 2, 1, SP_NCTX_REG, PIPE_NONE, 0, SP_TOP,
		gen8_1_0_non_context_sp_pipe_none_sp_top_registers, 0xae00},
	{ CLUSTER_NONE, UNSLICE, 2, 1, SP_NCTX_REG, PIPE_NONE, 0, USPTP,
		gen8_1_0_non_context_sp_pipe_none_usptp_registers, 0xae00},
	{ CLUSTER_NONE, UNSLICE, 2, 1, TP0_NCTX_REG, PIPE_NONE, 0, USPTP,
		gen8_1_0_non_context_tpl1_pipe_none_usptp_registers, 0xb600},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 0, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_registers, 0xa800},
	...
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 7, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 0, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 1, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 2, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 3, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 0, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_shared_const_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 1, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_shared_const_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 0, SP_TOP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_sp_top_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 1, SP_TOP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_sp_top_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 0, SP_TOP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_sp_top_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 1, SP_TOP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_sp_top_cctx_registers, 0xa800},
	...
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 0, USPTP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_usptp_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 1, USPTP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_usptp_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BR, 0, USPTP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_vs_usptp_shared_const_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 0, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_registers, 0xa800},
	...
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 7, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 0, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 1, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 2, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 3, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 0, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_shared_const_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 1, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_shared_const_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 0, SP_TOP,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_sp_top_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 1, SP_TOP,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_sp_top_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 0, SP_TOP,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_sp_top_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 1, SP_TOP,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_sp_top_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 0, USPTP,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_usptp_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 1, USPTP,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_usptp_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, SP_3D_CVS_REG, PIPE_BV, 0, USPTP,
		gen8_1_0_sp_slice_pipe_bv_cluster_sp_vs_usptp_shared_const_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 0, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_registers, 0xa800},
	...
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 7, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 0, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 1, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 2, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_cctx_registers, 0xa800},
	...
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 7, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 0, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_shared_const_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 1, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_shared_const_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 0, HLSQ_DP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_dp_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 1, HLSQ_DP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_dp_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 0, SP_TOP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_sp_top_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 1, SP_TOP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_sp_top_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 0, SP_TOP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_sp_top_cctx_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 1, SP_TOP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_sp_top_cctx_registers, 0xa800},
	...
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 0, USPTP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_usptp_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 1, USPTP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_usptp_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_BR, 0, USPTP,
		gen8_1_0_sp_slice_pipe_br_cluster_sp_ps_usptp_shared_const_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_LPAC, 0, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_hlsq_state_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_LPAC, 0, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_LPAC, 0, HLSQ_STATE,
		gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_hlsq_state_shared_const_registers,
		0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_LPAC, 0, HLSQ_DP,
		gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_hlsq_dp_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_LPAC, 0, SP_TOP,
		gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_sp_top_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_LPAC, 0, SP_TOP,
		gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_sp_top_cctx_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_LPAC, 0, USPTP,
		gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_usptp_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 1, SP_3D_CPS_REG, PIPE_LPAC, 0, USPTP,
		gen8_1_0_sp_slice_pipe_lpac_cluster_sp_ps_usptp_shared_const_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 1, TP_3D_CVS_REG, PIPE_BR, 0, USPTP,
		gen8_1_0_tpl1_slice_pipe_br_cluster_sp_vs_usptp_registers, 0xb000},
	{ CLUSTER_SP_VS, SLICE, 2, 1, TP_3D_CVS_REG, PIPE_BR, 1, USPTP,
		gen8_1_0_tpl1_slice_pipe_br_cluster_sp_vs_usptp_registers, 0xb000},
	{ CLUSTER_SP_VS, SLICE, 2, 1, TP_3D_CVS_REG, PIPE_BV, 0, USPTP,
		gen8_1_0_tpl1_slice_pipe_bv_cluster_sp_vs_usptp_registers, 0xb000},
	{ CLUSTER_SP_VS, SLICE, 2, 1, TP_3D_CVS_REG, PIPE_BV, 1, USPTP,
		gen8_1_0_tpl1_slice_pipe_bv_cluster_sp_vs_usptp_registers, 0xb000},
	{ CLUSTER_SP_PS, SLICE, 2, 1, TP_3D_CPS_REG, PIPE_BR, 0, USPTP,
		gen8_1_0_tpl1_slice_pipe_br_cluster_sp_ps_usptp_registers, 0xb000},
	{ CLUSTER_SP_PS, SLICE, 2, 1, TP_3D_CPS_REG, PIPE_BR, 1, USPTP,
		gen8_1_0_tpl1_slice_pipe_br_cluster_sp_ps_usptp_registers, 0xb000},
	{ CLUSTER_SP_PS, SLICE, 2, 1, TP_3D_CPS_REG, PIPE_LPAC, 0, USPTP,
		gen8_1_0_tpl1_slice_pipe_lpac_cluster_sp_ps_usptp_registers, 0xb000},
};

/*
 * CP indexed registers.
 * Note: Uses PIPE_* constants (same values as CP_PIPE_* in data file).
 * DDE pipe ROQ size differs from gen8_2_0 (0x01101 vs 0x01100).
 */
static struct gen8_cp_indexed_reg gen8_1_0_cp_indexed_reg_list[] = {
	...
	{ GEN8_CP_ROQ_DBG_ADDR_PIPE, GEN8_CP_ROQ_DBG_DATA_PIPE, UNSLICE, PIPE_DDE_BR, 0x00200},
	{ GEN8_CP_ROQ_DBG_ADDR_PIPE, GEN8_CP_ROQ_DBG_DATA_PIPE, UNSLICE, PIPE_DDE_BV, 0x00200},
...
/*
 * Misc registers list (GPU internal registers).
 * NULL-terminated - required by gen8_reglist_snapshot().
 * cx_misc is included here AND referenced separately via cx_misc_regs field.
 */
static struct gen8_reg_list gen8_1_0_misc_registers[] = {
	{ UNSLICE, gen8_1_0_gpu_registers },
	{ SLICE, gen8_1_0_gpu_slice_registers },
	{ UNSLICE, gen8_1_0_cx_misc_registers },
	/* Right now for gen8_1_0  we dont have the QDDS debug support, so skip below regs*/
	/*
	 * { UNSLICE, gen8_1_0_dbgc_registers },
	 * { SLICE, gen8_1_0_dbgc_slice_registers },
	 * { UNSLICE, gen8_1_0_cx_dbgc_registers },
	 */
	{ UNSLICE, NULL },
};

/*
 * AHB registers (pre-crashdumper registers).
 * These are dumped before the crashdumper runs.
 * gen8_1_0 only has GBIF registers (no ahb_precd or ahb_secure separate arrays
 * since those are included in gen8_1_0_gpu_registers).
 */
static struct gen8_reg_list gen8_1_0_ahb_registers[] = {
	{ UNSLICE, gen8_1_0_gbif_registers },
};
 ...
 * pairs   : 1 (Regs:256)
 */
static const u32 gen8_1_0_gx_clkctl_ahb2phy_broadcast_swman_registers[] = {
	0x19c00, 0x19cff,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gx_clkctl_ahb2phy_broadcast_swman_registers), 8));
 ...
 * pairs   : 1 (Regs:6)
 */
static const u32 gen8_1_0_gx_clkctl_ahb2phy_swman_registers[] = {
	0x19800, 0x19805,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gx_clkctl_ahb2phy_swman_registers), 8));
 ...
 * pairs   : 18 (Regs:170)
 */
static const u32 gen8_1_0_gx_clkctl_gx_clkctl_reg_registers[] = {
	0x1a000, 0x1a004, 0x1a008, 0x1a01a, 0x1a022, 0x1a022, 0x1a024, 0x1a02b,
	0x1a03f, 0x1a05d, 0x1a060, 0x1a063, 0x1a065, 0x1a066, 0x1a068, 0x1a076,
	0x1a078, 0x1a07c, 0x1a080, 0x1a080, 0x1a085, 0x1a085, 0x1a08d, 0x1a08d,
	0x1a0a1, 0x1a0a3, 0x1a0a6, 0x1a0a8, 0x1a0aa, 0x1a0aa, 0x1a0ae, 0x1a0b2,
	0x1a0b4, 0x1a0b5, 0x1a0b7, 0x1a0f5,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gx_clkctl_gx_clkctl_reg_registers), 8));
 ...
 * pairs   : 11 (Regs:131)
 */
static const u32 gen8_1_0_gdpm_lkg_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gdpm_lkg_registers), 8));
 ...
 * pairs   : 26 (Regs:536)
 */
static const u32 gen8_1_0_cpr_gmxc_registers[] = {
	...
	0x22880, 0x228a8, 0x22980, 0x229b0, 0x229c0, 0x229c3, 0x229c5, 0x229c8,
	0x229e0, 0x229f1, 0x229fb, 0x229ff, 0x22a02, 0x22a07, 0x22a09, 0x22a0b,
	0x22a10, 0x22b0f, 0x23000, 0x23010, 0x23031, 0x23040, 0x23480, 0x234a2,
	0x234ac, 0x234c4, 0x234d1, 0x234d6, 0x2358d, 0x2358d, 0x23590, 0x23590,
	0x235a0, 0x235a0, 0x235b0, 0x235b0,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cpr_gmxc_registers), 8));
 ...
 * pairs   : 26 (Regs:536)
 */
static const u32 gen8_1_0_cpr_registers[] = {
	...
	0x26a10, 0x26b0f, 0x27000, 0x27010, 0x27031, 0x27040, 0x27480, 0x274a2,
	0x274ac, 0x274c4, 0x274d1, 0x274d6, 0x2758d, 0x2758d, 0x27590, 0x27590,
	0x275a0, 0x275a0, 0x275b0, 0x275b0,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_cpr_registers), 8));
 ...
 * pairs   : 1 (Regs:14)
 */
static const u32 gen8_1_0_gpu_cc_pll0_cm_pll_taycan_common_registers[] = {
	0x24000, 0x2400d,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gpu_cc_pll0_cm_pll_taycan_common_registers), 8));
 ...
 * pairs   : 1 (Regs:256)
 */
static const u32 gen8_1_0_gpu_cc_ahb2phy_broadcast_swman_registers[] = {
	0x24c00, 0x24cff,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gpu_cc_ahb2phy_broadcast_swman_registers), 8));
 ...
 * pairs   : 1 (Regs:6)
 */
static const u32 gen8_1_0_gpu_cc_ahb2phy_swman_registers[] = {
	0x24800, 0x24805,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gpu_cc_ahb2phy_swman_registers), 8));
 ...
 * pairs   : 26 (Regs:134)
 */
static const u32 gen8_1_0_gpu_cc_gpu_cc_reg_registers[] = {
...
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gpu_cc_gpu_cc_reg_registers), 8));

/*
 * Block   : ['GCC_GPLL0_CM_PLL_TAYCAN_COMMON']
 * REGION  : UNSLICE
 * Pipeline: PIPE_NONE
 * pairs   : 1 (Regs:14)
 * Note: This is the GCC PLL register block (external to GPU CC)
 */
static const u32 gen8_1_0_gcc_gpll0_cm_pll_taycan_common_registers[] = {
	0x00000, 0x0000d,
	UINT_MAX, UINT_MAX,
};
static_assert(IS_ALIGNED(sizeof(gen8_1_0_gcc_gpll0_cm_pll_taycan_common_registers), 8));

/*
 * External core registers.
 * These are registers outside the GPU core (clock controllers, CPR, etc.)
 * Organized to match the kernel's gen8_snapshot_block_list structure:
 * - gx_clkctl registers go into gmu_gx_regs (not here)
 * - rscc registers go into rscc_regs field (not here)
 * - gmucx registers go into gmu_cx_unsliced_regs field (not here)
 */
static const u32 *gen8_1_0_external_core_regs[] = {
	gen8_1_0_gdpm_lkg_registers,
	gen8_1_0_gpu_cc_ahb2phy_swman_registers,
	gen8_1_0_cpr_registers,
	gen8_1_0_cpr_gmxc_registers,
	gen8_1_0_gpu_cc_ahb2phy_broadcast_swman_registers,
	gen8_1_0_gpu_cc_pll0_cm_pll_taycan_common_registers,
	gen8_1_0_gpu_cc_gpu_cc_reg_registers,
	gen8_1_0_gcc_gpll0_cm_pll_taycan_common_registers,
};

/*
 * GMU GX registers.
 * Includes GX domain GMU registers and GX clock controller registers.
 * The gmucx (CX domain) registers are handled separately via gmu_cx_unsliced_regs.
 */
static struct gen8_reg_list gen8_1_0_gmu_gx_registers[] = {
	{ UNSLICE, gen8_1_0_gmugx_registers },
	{ SLICE, gen8_1_0_gmugx_slice_registers },
	{ UNSLICE, gen8_1_0_gmuao_registers },
	{ UNSLICE, gen8_1_0_gx_clkctl_gx_clkctl_reg_registers },
	{ UNSLICE, gen8_1_0_gx_clkctl_ahb2phy_broadcast_swman_registers },
	{ UNSLICE, gen8_1_0_gx_clkctl_ahb2phy_swman_registers },
};

#endif /* __ADRENO_GEN8_1_0_SNAPSHOT_H */
